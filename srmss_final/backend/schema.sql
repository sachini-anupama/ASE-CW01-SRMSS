...
CREATE TABLE Vehicle (
    ...
    FuelType        VARCHAR(30)     DEFAULT 'Diesel',
    InsuranceExpiry DATE,
    Status          ENUM('Available', 'In Service', 'Under Maintenance') NOT NULL DEFAULT 'Available',
...
CREATE TABLE Driver (
    ...
    LicenseType     VARCHAR(60)     DEFAULT 'Heavy Vehicle',
...
CREATE TABLE MaintenanceLog (
    ...
    Cost                DECIMAL(10,2),
    NextDueDate         DATE,
    NextServiceMileage  DECIMAL(10,2),
...
CREATE TABLE Schedule (
    ...
    SequenceOrder       INT,
    ScheduleType        VARCHAR(30)     DEFAULT 'One-off',
    Remarks             TEXT,
...
('Kamal Perera', 'kamal@srmss.lk', '0771234567', 'password123', 'Active', 1),
('Nimal Silva',  'nimal@srmss.lk', '0712345678', 'password123', 'Active', 2),
('Sunil Bandara','sunil@srmss.lk', '0761234567', 'password123', 'Active', 4);
...
('System Ready', 'SRMSS modules are connected to the live database.', 'success'),
('Maintenance Due', 'Review upcoming maintenance records for due vehicles.', 'warning'),
('Schedules Updated', 'Trip schedules are available for dispatch review.', 'info');
